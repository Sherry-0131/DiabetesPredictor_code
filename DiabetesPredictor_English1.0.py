...
class DiabetesPredictorApp(tk.Tk):
    ...
    def show_selection_page(self):
        self.clear_frame()
        ttk.Label(self, text="Please Select Data Input & Prediction Mode", style="Header.TLabel").pack(pady=80)
        ...
        ttk.Button(self, text="Logout", command=self.show_login_page).pack(side="bottom", pady=50)
