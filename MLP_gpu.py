...
# ==========================================
# 🚀 设备检测 (GPU / CPU) - 已修复字符转换报错
# ==========================================
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print(f"=== Running Paradigm: Using Device -> [{device.type.upper()}] ===\n")
...
# 实例化模型并推入指定设备 (GPU/CPU)
model = DiabetesDeepPredictor(input_dim=X_train.shape[1]).to(device)
